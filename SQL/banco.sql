...
ALTER TABLE `fir` ADD CONSTRAINT `fk_userid` FOREIGN KEY (`id`) REFERENCES `user` (`id`);
ALTER TABLE `auditdata` ADD KEY `FK_auditdata_fir` (`auditID`);
ALTER TABLE `auditdata` ADD CONSTRAINT `FK_auditdata_fir` FOREIGN KEY (`auditID`) REFERENCES `fir` (`id`);
